package com.yzy.myaccount.update;
...
public class UpdateManager
{
	...
	private boolean isUpdate() throws IOException
	{
		...
		URL url = new URL("http://yzy.hgfree.kuxier.club/apk/update.xml");
	...
	private int getVersionCode(Context context)
	{
		...
		try
		{
			...
			versionCode = context.getPackageManager().getPackageInfo("com.yzy.myaccount", 0).versionCode;
