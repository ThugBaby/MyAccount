...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	private static final String TEMP6 = "alter table  tb_type rename to temp_type";
	private static final String TEMP7 = "alter table  tb_atype rename to temp_atype";
	...
	private static final String cTEMP6 = "insert into tb_type select * from temp_type";
	private static final String cTEMP7 = "insert into tb_atype select * from temp_atype";
	// 删除备份表
	...
	public static final String dTEMP6 = "drop table if exists temp_type";
	public static final String dTEMP7 = "drop table if exists temp_atype";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS tb_type(_id integer primary key autoincrement,type varchar(20))");
		db.execSQL("CREATE TABLE IF NOT EXISTS tb_atype(_id integer primary key autoincrement,type varchar(20))");
